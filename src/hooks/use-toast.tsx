...
import type {
  ToastActionElement, // Already expecting a React.ReactElement
  ToastProps,
...
type ToasterToast = ToastProps & {
  ...
  action?: ToastActionElement // This is key, it's a React.ReactElement
}
...
function toast({ ...props }: Toast) {
  ...
  dispatch({
    ...
    toast: {
      ...
      id,
      open: true,
      action: currentAction, // Use the potentially modified action
      onOpenChange: (open) => {
        if (!open) dismiss()
      },
    },
